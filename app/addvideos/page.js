  ...
  return (
    <div className="max-w-6xl mx-auto p-6">
      <form onSubmit={handleSubmit} noValidate className="flex flex-col gap-6">
        ...
        <input className="input" type="text" placeholder="YouTube Video URL" value={videoUrl} onChange={(e) => setVideoUrl(e.target.value)} />
        <input className="input" type="text" placeholder="GIF URL" value={gifUrl} onChange={(e) => setGifUrl(e.target.value)} />
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
            {muscleGroups.map((muscle) => (
              <div
                ...
                className={`cursor-pointer rounded-md p-1 transition-opacity duration-150 ${
      ...
      {success && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white p-6 rounded-xl shadow-xl w-96 text-center">
            ...
            <p className="text-gray-700 mb-6">Your video was added successfully.</p>
